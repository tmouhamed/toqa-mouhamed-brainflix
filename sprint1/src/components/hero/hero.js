    ...
    render() {
        return (
            <section className="main__hero">
                <video className="main__hero-video" poster={this.props.mainVideo.image}></video>
                <img className="main__hero-icons main__hero-icons__left" src={PlayIcon} alt="play icon"></img>
               <div className="main__hero-icons main__hero-icons__center"> <span ></span></div>
                <div className="main__hero-icons main__hero-icons__right">
                    ...
                    <img className="main__hero-icons__right" src={VolumeIcon} alt="volume icon"></img>
                </div>
            </section>
        );
    }
